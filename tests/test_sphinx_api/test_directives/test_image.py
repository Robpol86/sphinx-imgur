...
def test_width(tmpdir, docs, httpretty_common_mock, set_conf):
    ...
    href_i = (
        '<a class="reference internal image-reference" href="_images/611EovQ.jpg">'
    ...
    if set_conf and set_conf != "gallery":
        ...
        href = (
            '<a class="reference external image-reference" href="{}">' '<img alt="Work, June 1st, 2016: Uber" %s></a>'
        ).format(url)
    else:
        href = (
            '<a class="reference external image-reference" href="//i.imgur.com/611EovQ.jpg">'
...
def test_missing_api_data(tmpdir, docs):
    ...
    href_i = (
        '<a class="reference internal image-reference" href="https://i.imgur.com/imgur0idh.jpg">'
        '<img alt="https://i.imgur.com/imgur0idh.jpg" %s /></a>'
    )
    href = (
        '<a class="reference external image-reference" href="//i.imgur.com/imgur0id.jpg">'
